...
from app.infrastructure.storage import uploads as upload_service
from app.presentation.api.v1.admin.deps import AdminUser, SameOrigin
from app.presentation.schemas.admin_common import MessageOut
from app.presentation.schemas.admin_meta import (
    UploadCommitOut,
    UploadCommitRequest,
    UploadRevertRequest,
    UploadStageOut,
