...
from app.infrastructure.persistence.models import Bus, BusService
from app.infrastructure.persistence.models.fleet import bus_bus_service
...
from app.presentation.schemas.admin_fleet import (
    BusOut,
    BusServiceOut,
    BusServiceWrite,
    BusWrite,
